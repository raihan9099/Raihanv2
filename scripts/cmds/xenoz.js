...
module.exports = {
  config: {
    name: "xenoz",
    aliases: ["xenozedit", "xeonz"],
    version: "1.0",
    author: "Arafat Da",
    countDown: 5,
    role: 0,
    shortDescription: "📥 Xenozedit ইউটিউব থেকে রেন্ডম ভিডিও আনো",
    longDescription: "📥 YouTube চ্যানেল xenozedit থেকে রেন্ডম ভিডিও আনো",
    category: "media",
    guide: "{pn} অথবা {pn} xenoz"
  },
  ...
  onStart: async function ({ api, event, message }) {
    ...
    try {
      const channelHandle = "xenozedit"; // ইউটিউব হ্যান্ডেল
      ...
      const filePath = path.join(dir, "xenozVideo.mp4");
